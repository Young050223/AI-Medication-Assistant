...
- Capacitor iOS runtime for simulator/native packaging
- Supabase Edge Functions for backend/AI integration
- Custom icon components in `src/components/Icons.tsx`
- React Context + localStorage for lightweight client persistence
...
- Animation: restrained CSS transitions only unless a dependency is explicitly added
